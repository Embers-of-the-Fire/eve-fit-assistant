...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 2079460456;
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        1 => wire__crate__api__data__EveDatabase_init_impl(port, ptr, rust_vec_len, data_len),
        4 => wire__crate__api__proxy__modules_proxy_default_impl(port, ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
...
fn pde_ffi_dispatcher_sync_impl(
    ...
    // Codec=Pde (Serialization + dispatch), see doc to use other codecs
    match func_id {
        2 => wire__crate__api__calculate_impl(ptr, rust_vec_len, data_len),
        3 => wire__crate__api__get_type_attr_impl(ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
