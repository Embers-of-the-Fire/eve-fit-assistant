...
- **Report & Feedback** — submit feedback. See [Report Feedback](efa://manual/pages/settings/report-feedback).
- **Sponsor Us** — opens the sponsorship page in your browser.
- **Version** — view app version info and updates; the number of unread version posts appears as a red badge. See [Version](efa://manual/pages/settings/version).

On the web, the Version item does not show the unread badge.