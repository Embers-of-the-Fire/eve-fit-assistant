...
_DamageProfile _$DamageProfileFromJson(Map<String, dynamic> json) => _DamageProfile(
...
Map<String, dynamic> _$DamageProfileToJson(_DamageProfile instance) => <String, dynamic>{
      'em': instance.em,
