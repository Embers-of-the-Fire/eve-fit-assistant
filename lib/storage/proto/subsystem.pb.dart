...
class ShipSubsystem_Ship extends $pb.GeneratedMessage {
  ...
  factory ShipSubsystem_Ship.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);

  factory ShipSubsystem_Ship.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ShipSubsystem.Ship',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'subsystem'),
      createEmptyInstance: create)
    ..p<$core.int>(1, _omitFieldNames ? '' : 'offensive', $pb.PbFieldType.P3)
    ..a<$core.int>(2, _omitFieldNames ? '' : 'offensiveMarket', $pb.PbFieldType.Q3,
        protoName: 'offensiveMarket')
    ..p<$core.int>(3, _omitFieldNames ? '' : 'propulsion', $pb.PbFieldType.P3)
    ..a<$core.int>(4, _omitFieldNames ? '' : 'propulsionMarket', $pb.PbFieldType.Q3,
        protoName: 'propulsionMarket')
    ..p<$core.int>(5, _omitFieldNames ? '' : 'core', $pb.PbFieldType.P3)
    ..a<$core.int>(6, _omitFieldNames ? '' : 'coreMarket', $pb.PbFieldType.Q3,
        protoName: 'coreMarket')
    ..p<$core.int>(7, _omitFieldNames ? '' : 'defensive', $pb.PbFieldType.P3)
    ..a<$core.int>(8, _omitFieldNames ? '' : 'defensiveMarket', $pb.PbFieldType.Q3,
        protoName: 'defensiveMarket');
  ...
  ShipSubsystem_Ship copyWith(void Function(ShipSubsystem_Ship) updates) =>
      super.copyWith((message) => updates(message as ShipSubsystem_Ship)) as ShipSubsystem_Ship;
  ...
  @$core.pragma('dart2js:noInline')
  static ShipSubsystem_Ship getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ShipSubsystem_Ship>(create);
  ...
  @$pb.TagNumber(2)
  set offensiveMarket($core.int v) {
    $_setSignedInt32(1, v);
  }
  ...
  @$pb.TagNumber(4)
  set propulsionMarket($core.int v) {
    $_setSignedInt32(3, v);
  }
  ...
  @$pb.TagNumber(8)
  set defensiveMarket($core.int v) {
    $_setSignedInt32(7, v);
  }
...
class ShipSubsystem_Subsystem extends $pb.GeneratedMessage {
  ...
  factory ShipSubsystem_Subsystem.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);

  factory ShipSubsystem_Subsystem.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  ShipSubsystem_Subsystem copyWith(void Function(ShipSubsystem_Subsystem) updates) =>
  ...
  static $pb.PbList<ShipSubsystem_Subsystem> createRepeated() =>
      $pb.PbList<ShipSubsystem_Subsystem>();

  @$core.pragma('dart2js:noInline')
  static ShipSubsystem_Subsystem getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ShipSubsystem_Subsystem>(create);
...
class ShipSubsystem extends $pb.GeneratedMessage {
  ...
  factory ShipSubsystem.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);

  factory ShipSubsystem.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ShipSubsystem',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'subsystem'),
      createEmptyInstance: create)
    ...
    ..m<$core.int, ShipSubsystem_Subsystem>(2, _omitFieldNames ? '' : 'subsystems',
  ...
  ShipSubsystem copyWith(void Function(ShipSubsystem) updates) =>
      super.copyWith((message) => updates(message as ShipSubsystem)) as ShipSubsystem;
  ...
  @$core.pragma('dart2js:noInline')
  static ShipSubsystem getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ShipSubsystem>(create);
