...
class Attributes_Attribute extends $pb.GeneratedMessage {
  ...
  factory Attributes_Attribute.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory Attributes_Attribute.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Attributes.Attribute',
    ...
    ..a<$core.int>(3, _omitFieldNames ? '' : 'categoryID', $pb.PbFieldType.O3,
  ...
  Attributes_Attribute copyWith(void Function(Attributes_Attribute) updates) =>
      super.copyWith((message) => updates(message as Attributes_Attribute)) as Attributes_Attribute;
  ...
  @$core.pragma('dart2js:noInline')
  static Attributes_Attribute getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<Attributes_Attribute>(create);
...
class Attributes extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Attributes',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'attribute'),
      createEmptyInstance: create)
  ...
  @$core.pragma('dart2js:noInline')
  static Attributes getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<Attributes>(create);
