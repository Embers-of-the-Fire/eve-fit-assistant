...
class Ships_Ship extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Ships.Ship', package: const $pb.PackageName(_omitMessageNames ? '' : 'ships'), createEmptyInstance: create)
    ...
    ..a<$core.bool>(8, _omitFieldNames ? '' : 'hasSubsystem', $pb.PbFieldType.QB, protoName: 'hasSubsystem')
    ...
    ..a<$core.bool>(13, _omitFieldNames ? '' : 'hasFighter', $pb.PbFieldType.QB, protoName: 'hasFighter')
  ;
  ...
  @$pb.TagNumber(8)
  set hasSubsystem($core.bool v) { $_setBool(7, v); }
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(13)
  set hasFighter($core.bool v) { $_setBool(12, v); }
  @$pb.TagNumber(13)
  $core.bool hasHasFighter() => $_has(12);
  @$pb.TagNumber(13)
  void clearHasFighter() => clearField(13);
}
