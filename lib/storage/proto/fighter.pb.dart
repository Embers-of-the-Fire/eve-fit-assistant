...
class Fighters_Fighter extends $pb.GeneratedMessage {
  ...
  factory Fighters_Fighter.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory Fighters_Fighter.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Fighters.Fighter',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'fighter'),
      createEmptyInstance: create)
    ..e<Fighters_FighterType>(1, _omitFieldNames ? '' : 'type', $pb.PbFieldType.QE,
        defaultOrMaker: Fighters_FighterType.LIGHT,
        valueOf: Fighters_FighterType.valueOf,
        enumValues: Fighters_FighterType.values)
  ...
  Fighters_Fighter copyWith(void Function(Fighters_Fighter) updates) =>
      super.copyWith((message) => updates(message as Fighters_Fighter)) as Fighters_Fighter;
  ...
  @$core.pragma('dart2js:noInline')
  static Fighters_Fighter getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<Fighters_Fighter>(create);
  static Fighters_Fighter? _defaultInstance;

  @$pb.TagNumber(1)
  Fighters_FighterType get type => $_getN(0);
  @$pb.TagNumber(1)
  set type(Fighters_FighterType v) {
    setField(1, v);
  }
...
class Fighters extends $pb.GeneratedMessage {
  ...
  Fighters._() : super();
  factory Fighters.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory Fighters.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Fighters',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'fighter'),
      createEmptyInstance: create)
