...
class TypeSkills_Skill extends $pb.GeneratedMessage {
  ...
  factory TypeSkills_Skill.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory TypeSkills_Skill.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TypeSkills.Skill', package: const $pb.PackageName(_omitMessageNames ? '' : 'skills'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  TypeSkills_Skill copyWith(void Function(TypeSkills_Skill) updates) => super.copyWith((message) => updates(message as TypeSkills_Skill)) as TypeSkills_Skill;
  ...
  @$core.pragma('dart2js:noInline')
  static TypeSkills_Skill getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<TypeSkills_Skill>(create);
...
class TypeSkills_TypeSkill extends $pb.GeneratedMessage {
  ...
  factory TypeSkills_TypeSkill.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory TypeSkills_TypeSkill.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TypeSkills.TypeSkill', package: const $pb.PackageName(_omitMessageNames ? '' : 'skills'), createEmptyInstance: create)
    ..pc<TypeSkills_Skill>(1, _omitFieldNames ? '' : 'skills', $pb.PbFieldType.PM, subBuilder: TypeSkills_Skill.create)
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  TypeSkills_TypeSkill copyWith(void Function(TypeSkills_TypeSkill) updates) => super.copyWith((message) => updates(message as TypeSkills_TypeSkill)) as TypeSkills_TypeSkill;
  ...
  @$core.pragma('dart2js:noInline')
  static TypeSkills_TypeSkill getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<TypeSkills_TypeSkill>(create);
...
class TypeSkills extends $pb.GeneratedMessage {
  ...
  TypeSkills._() : super();
  factory TypeSkills.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory TypeSkills.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TypeSkills', package: const $pb.PackageName(_omitMessageNames ? '' : 'skills'), createEmptyInstance: create)
    ..m<$core.int, TypeSkills_TypeSkill>(1, _omitFieldNames ? '' : 'entries', entryClassName: 'TypeSkills.EntriesEntry', keyFieldType: $pb.PbFieldType.O3, valueFieldType: $pb.PbFieldType.OM, valueCreator: TypeSkills_TypeSkill.create, valueDefaultOrMaker: TypeSkills_TypeSkill.getDefault, packageName: const $pb.PackageName('skills'))
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  TypeSkills copyWith(void Function(TypeSkills) updates) => super.copyWith((message) => updates(message as TypeSkills)) as TypeSkills;
  ...
  @$core.pragma('dart2js:noInline')
  static TypeSkills getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<TypeSkills>(create);
