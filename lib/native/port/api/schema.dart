...
class Booster {
  ...
  const Booster({required this.itemId, required this.index});
...
class DynamicItem {
  ...
  const DynamicItem({required this.baseType, required this.dynamicAttributes});
...
enum ItemState { passive, online, active, overload }
