...
final AttributesProxy attributes;
                ...
                const ItemProxy({this.index ,required this.itemId ,this.charge ,required this.attributes ,});
        ...
        bool operator ==(Object other) =>
            ...
            other is ItemProxy &&
                ...
                && index == other.index&& itemId == other.itemId&& charge == other.charge&& attributes == other.attributes;
...
final ItemProxy? tacticalMode;
                ...
                const ModulesProxy({required this.high ,required this.medium ,required this.low ,required this.rig ,required this.subsystem ,this.tacticalMode ,});
...
final ItemProxy character;
                ...
                const ShipProxy({required this.hull ,required this.modules ,required this.implants ,required this.character ,});
        ...
        bool operator ==(Object other) =>
            ...
            other is ShipProxy &&
                runtimeType == other.runtimeType
                && hull == other.hull&& modules == other.modules&& implants == other.implants&& character == other.character;
