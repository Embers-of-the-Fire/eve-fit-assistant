...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => 2079460456;
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  TaskConstMeta get kCrateApiCalculateConstMeta =>
      const TaskConstMeta(debugName: "calculate", argNames: ["db", "fit"]);
  ...
  TaskConstMeta get kCrateApiProxyModulesProxyDefaultConstMeta =>
      const TaskConstMeta(debugName: "modules_proxy_default", argNames: []);
  ...
  @protected
  Map<int, DynamicItem> dco_decode_Map_i_32_dynamic_item_None(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return Map.fromEntries(
      dco_decode_list_record_i_32_dynamic_item(
        raw,
  ...
  DynamicItem dco_decode_dynamic_item(dynamic raw) {
    ...
    return DynamicItem(
      ...
      dynamicAttributes: dco_decode_Map_i_32_f_64_None(arr[1]),
    );
  }
  ...
  ErrorKey dco_decode_error_key(dynamic raw) {
    ...
    switch (raw[0]) {
      ...
      case 4:
        return ErrorKey_ConflictItem(groupId: dco_decode_i_32(raw[1]));
      case 5:
        return ErrorKey_DuplicateBooster(slot: dco_decode_i_32(raw[1]));
      case 6:
  ...
  Fit dco_decode_fit(dynamic raw) {
    ...
    return Fit(
      ...
      skills: dco_decode_Map_i_32_u_8_None(arr[6]),
      damageProfile: dco_decode_damage_profile(arr[7]),
      dynamicItems: dco_decode_Map_i_32_dynamic_item_None(arr[8]),
    );
  }
  ...
  ItemProxy dco_decode_item_proxy(dynamic raw) {
    ...
    return ItemProxy(
      ...
      attributes: dco_decode_Map_i_32_f_64_None(arr[4]),
  ...
  (int, DynamicItem) dco_decode_record_i_32_dynamic_item(dynamic raw) {
    ...
    return (dco_decode_i_32(arr[0]), dco_decode_dynamic_item(arr[1]));
  }
  ...
  WarningKey dco_decode_warning_key(dynamic raw) {
    ...
    switch (raw[0]) {
      ...
      case 1:
        return WarningKey_Placeholder(dco_decode_i_32(raw[1]));
      default:
        throw Exception("unreachable");
    }
  }
  ...
  @protected
  Map<int, DynamicItem> sse_decode_Map_i_32_dynamic_item_None(
    SseDeserializer deserializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
  ...
  DynamicItem sse_decode_dynamic_item(SseDeserializer deserializer) {
    ...
    var var_dynamicAttributes = sse_decode_Map_i_32_f_64_None(deserializer);
    return DynamicItem(
      baseType: var_baseType,
      dynamicAttributes: var_dynamicAttributes,
    );
  }
  ...
  Fit sse_decode_fit(SseDeserializer deserializer) {
    ...
    var var_skills = sse_decode_Map_i_32_u_8_None(deserializer);
    var var_damageProfile = sse_decode_damage_profile(deserializer);
    var var_dynamicItems = sse_decode_Map_i_32_dynamic_item_None(deserializer);
    return Fit(
      shipId: var_shipId,
      modules: var_modules,
      drones: var_drones,
  ...
  ItemProxy sse_decode_item_proxy(SseDeserializer deserializer) {
    ...
    var var_attributes = sse_decode_Map_i_32_f_64_None(deserializer);
  ...
  sse_encode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerEveDatabase(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize(
      (self as EveDatabaseImpl).frbInternalSseEncode(move: true),
      serializer,
    );
  }
  ...
  @protected
  void sse_encode_Map_i_32_dynamic_item_None(
    Map<int, DynamicItem> self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
  ...
  sse_encode_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerEveDatabase(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize(
      (self as EveDatabaseImpl).frbInternalSseEncode(move: null),
      serializer,
    );
  }
  ...
  void sse_encode_dynamic_item(DynamicItem self, SseSerializer serializer) {
    ...
    sse_encode_Map_i_32_f_64_None(self.dynamicAttributes, serializer);
  }
  ...
  void sse_encode_fit(Fit self, SseSerializer serializer) {
    ...
    sse_encode_Map_i_32_u_8_None(self.skills, serializer);
    sse_encode_damage_profile(self.damageProfile, serializer);
    sse_encode_Map_i_32_dynamic_item_None(self.dynamicItems, serializer);
  }
  ...
  void sse_encode_item_proxy(ItemProxy self, SseSerializer serializer) {
    ...
    sse_encode_Map_i_32_f_64_None(self.attributes, serializer);
