  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final desc = switch (prices) {
      ...
      AsyncData(:final value) => ListTile(
          title: Text('欧服：买单：${value.tranquility.buy.min.moneyFormat}\n'
              '　　　卖单：${value.tranquility.sell.max.moneyFormat}\n'
              '国服：买单：${value.serenity.buy.min.moneyFormat}\n'
              '　　　卖单：${value.serenity.sell.max.moneyFormat}'),
        ),
