...
_CharacterSkills _$CharacterSkillsFromJson(Map<String, dynamic> json) => _CharacterSkills(
...
Map<String, dynamic> _$CharacterSkillsToJson(_CharacterSkills instance) => <String, dynamic>{
      'total_sp': instance.totalSP,
      'unallocated_sp': instance.unallocatedSP,
      'skills': instance.skills,
    };

_CharacterSkillItem _$CharacterSkillItemFromJson(Map<String, dynamic> json) => _CharacterSkillItem(
...
Map<String, dynamic> _$CharacterSkillItemToJson(_CharacterSkillItem instance) => <String, dynamic>{
