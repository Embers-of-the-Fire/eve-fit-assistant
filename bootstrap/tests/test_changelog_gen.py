...
from bootstrap.release.changelog_gen import _version_to_doc_id
from bootstrap.release.changelog_gen import _write_version_documents
...
class TestWriteVersionDocuments:
    def test_writes_en_and_zh_files(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            root = Path(tmpdir)
            with patch("bootstrap.release.changelog_gen.ANNOUNCEMENTS_ROOT", root):
    ...
    def test_creates_parent_directories(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            with patch("bootstrap.release.changelog_gen.ANNOUNCEMENTS_ROOT", nested):
                _write_version_documents(v, en_body, zh_body, cliff_body)
