...
from data.lib.docs.announcements import LocalizedAnnouncementStub
from data.lib.docs.announcements import _compute_body_hash
from data.lib.docs.announcements import _extract_announcement_content
from data.lib.docs.announcements import _extract_summary
from data.lib.docs.announcements import _parse_front_matter
from data.lib.docs.announcements import _parse_source_metadata
from data.lib.docs.announcements import build_bundled_announcements
...
class TestBuildBundledAnnouncements:
    ...
    def test_empty_source_directory(self):
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            with (
                patch(
                    "data.lib.docs.announcements.ANNOUNCEMENTS_ROOT",
                    anno_root,
                ),
                patch(
                    "data.lib.docs.announcements.GENERATED_ROOT",
                    gen_root,
                ),
                patch(
                    "data.lib.docs.announcements.GENERATED_CATALOG_PATH",
                    gen_root / "catalog.json",
                ),
                patch(
                    "data.lib.docs.announcements.GENERATED_DOCUMENTS_ROOT",
                    gen_root / "documents",
                ),
                patch(
                    "data.lib.docs.announcements.GENERATED_GITIGNORE_PATH",
                    gen_root / ".gitignore",
                ),
                patch(
                    "data.lib.docs.announcements.DOCUMENTS_GITKEEP_PATH",
