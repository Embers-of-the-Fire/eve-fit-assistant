...
// (CLOUDFLARE_ENV=preview) use the empty origin so calls stay same-origin
// through the /platform/* proxy endpoint, everything else bakes in the
// production API origin (see astro.config.mjs).
