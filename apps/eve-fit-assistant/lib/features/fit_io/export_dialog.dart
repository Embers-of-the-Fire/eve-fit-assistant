...
class _FitExportDialogState extends ConsumerState<FitExportDialog> {
  ...
  Widget build(BuildContext context) => AppDialog(
    ...
    actions: [
      ...
      TextButton(
        onPressed: _fit == null || _isExporting ? null : _handleSend,
        child: Text(context.l10n.fitExportSendButton),
      ),
      TextButton(
  ...
  /// The OS share sheet, handing the exported text to other apps.
